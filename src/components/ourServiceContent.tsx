...
function OurServiceContent() {
  return (
    <section className="ourServiceContent" id="ourServiceContent">
      <Container>
        <Row className="justify-content-md-around justify-content-center">
          <Col lg={6} className="align-self-center ourServiceContent-Content--img">
            <Image src="https://i.postimg.cc/T3mkVZyt/Happy-Girl-961x1443-2.png" rounded alt="..." id="ourServiceContent-imageCarContent" />
